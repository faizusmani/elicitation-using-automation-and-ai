...
<img src='./Documentation/flow-detailed.svg' width='80%' alt="Project Flow Diagram">
...
<ul>
  ...
  <li>Another pre-trained AI model for Text translation was used to translate the information extracted in English from the previous step to some of the main languages of the countries where the ProCredit Group operates i.e. German, Ukrainian, Bosnian, Bulgarian.</li>
